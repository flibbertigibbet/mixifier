...
2. Add a file named 'secrets.py' the 'mixifier' directory.  In the file, define ECHO_NEST_API_KEY (your API key),  
and DJANGO_SECRET_KEY (a random, unique string for your web app).  
